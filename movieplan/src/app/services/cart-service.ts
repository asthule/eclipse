...
import { Medicine } from "../models/movieplan.model";
...
export class CartServices {
    ...
    public updateCartItem(updateCartItem: CartItem): Observable<CartItem>{
        return this.http.put<CartItem>(
            `${this.hostUrl}` + `/cart/${updateCartItem.id}`,
            updateCartItem
        );
    }

    public deleteCartItem(id: number): Observable<CustomerHttpResponse> {
        console.log(id);
    ...
    public createCartItem(medicine: Medicine): CartItem{
    ...
    public editCartItem(cartItem: CartItem): CartItem {
        ...
        cartItem.medicineName = cartItem.medicineName;
